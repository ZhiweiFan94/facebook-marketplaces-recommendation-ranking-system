...
class FeatureExtractor(nn.Module):
    """
    Load pretrained weights and modify the layers for feature extraction 
    """
    def __init__(self):
        ...
        # Load model weights
        self.main.load_state_dict(torch.load('resnet_epoch_9_val_loss_0.2843_val_acc_68.49.pth'))
...
def predict_image(image: UploadFile = File(...)):
    """
    API serves feature embeddings extraction
    """
...
def predict_combined(image: UploadFile = File(...), text: str = Form(...)):
    """
    API serves similar images search using FAISS
    """
